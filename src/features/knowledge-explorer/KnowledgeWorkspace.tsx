...
import { ChatHistoryMessage, FileAsset, Locale, Thread } from "@/lib/domain/types";
              ...
              <button
                ...
                onClick={() => {
                  ...
                  void createChildCard({
                    ...
                    value:
                      locale === "zh"
                        ? `请结合上游内容，深入解释“${termPreview.term}”。`
                        : `Using the upstream context, explain “${termPreview.term}” in depth. Respond in English.`,
                  });
                }}
              >
                {creatingCard ? (
